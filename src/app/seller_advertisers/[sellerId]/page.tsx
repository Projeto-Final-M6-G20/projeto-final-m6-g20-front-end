...
const PageAdAdvertiser = ({ params }: { params: { sellerId: string } }) => {
  ...
  return (
    <main className="flex flex-col gap-10  pt-28 min-w-full items-center backgroundImage bg-no-repeat ">
      <Container>
        <div className="flex flex-col gap-10 min-w-full items-center ">
          ...
          <div className="w-10/12 mb-8 bg-white flex flex-col align-center p-5">
